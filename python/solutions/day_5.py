...
class Day5(Base):
    ...
    def parse_input(self):
        ...
        map_texts = [d.strip().split("\n")[1:] for d in data[1:]]
        maps = [[[int(n) for n in line.split()] for line in m] for m in map_texts]
